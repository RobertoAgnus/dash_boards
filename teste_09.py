...
# senha_digitada = "teste"

# hash_salvo = "$2b$12$aJpB8YAsYpH2D8efaS56WOgudG.9X4wfLZPbTYOobaaYCdRTCCJ7W"

# print(bcrypt.checkpw(senha_digitada.encode(), hash_salvo.encode()))
