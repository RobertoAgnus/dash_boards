...
with st.container():
    ...
    with col_1:
        ...
        # df_total_clientes_unicos = pd.read_sql(total_clientes, conn)
        df_total_clientes_unicos = dk.query(total_clientes_unicos).to_df()
        ...
        # df_clientes_atendidos = pd.read_sql(qtd_clientes_atendidos, conn)
        df_clientes_atendidos = dk.query(qtd_clientes_atendidos).to_df()
